...
appid = "d5558c6e"     #填写控制台中获取的 APPID 信息
api_secret = "YWQyNjhhZTZmODExMTdkNGM5OWEyMTMw"   #填写控制台中获取的 APISecret 信息
api_key ="79b1d0ee43d92fd8a0b26cc285b0d568"    #填写控制台中获取的 APIKey 信息
...
text =[
    ...
    # {"role": "user", "content": "你需要把我之后输入的内容转换成如下格式的指令:"}
    {"role": "user", "content": "你需要把我之后输入的内容解释一遍"}
]
